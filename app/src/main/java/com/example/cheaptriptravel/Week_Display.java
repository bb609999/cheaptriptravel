...
public class Week_Display extends AppCompatActivity implements WeekView.EventClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week__display);
        ...
        Button insertDatabase = (Button) findViewById(R.id.insert_database);
        insertDatabase.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Schedule schedule = new Schedule();
                schedule.setEvent_Name("E1");
                schedule.setStart_time(3.5);
                schedule.setEnd_time(4.5);
                schedule.save();
            }
        });
        ...
        queryDatabase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(Schedule schedule: Schedules) {
                    Log.d("00002", " " + schedule.getEvent_Name() +
    ...
    public void onEventClick(WeekViewEvent event, RectF eventRect) {
        ...
        Calendar end_time = event.getEndTime();
    ...
    public List<? extends WeekViewEvent> onMonthChange(int newYear, int newMonth) {
        ...
        for(Schedule schedule: Schedules) {
            ...
            startTime.set(Calendar.HOUR_OF_DAY, (int)schedule.getStart_time());
            startTime.set(Calendar.MINUTE, 20);
            startTime.set(Calendar.MONTH, newMonth-1);
            startTime.set(Calendar.YEAR, newYear);
            endTime = (Calendar) startTime.clone();
            endTime.set(Calendar.HOUR_OF_DAY, (int)schedule.getEnd_time());
